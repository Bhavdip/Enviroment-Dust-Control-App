...
public class PdfCreator {
	  ...
	  public static void createDocument(String filePath){
		  ...
		  try {
			      ...
			      PdfWriter.getInstance(document, new FileOutputStream(String.format("%s %s",filePath,composeFileName)));
			      document.open();
	  ...
	  private static void addTitlePage(Document document)
		...
		for (int i = 0; i < 10; i++) {
		    ...
		    preface.add(new Paragraph(String.format("Customer%1d %10s",i,"IHES"), normalFont));
	    }
